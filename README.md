...
| DripStack (premium financial newsletters) | Opt-in: `--search dripstack` per run, or `INCLUDE_SOURCES=dripstack` in `.env` | `DRIPSTACK_API_KEY` required (get one at dripstack.xyz) |
